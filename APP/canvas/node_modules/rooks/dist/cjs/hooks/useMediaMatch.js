...
function useMediaMatch(query) {
    ...
    var matchMedia = (0, react_1.useMemo)(function () { return window.matchMedia(query); }, [
        query,
    ]);
    var _a = (0, react_1.useState)(function () { return matchMedia.matches; }), matches = _a[0], setMatches = _a[1];
